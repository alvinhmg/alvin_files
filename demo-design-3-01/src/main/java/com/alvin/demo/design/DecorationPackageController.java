...
import com.alvin.design.Matter;
import com.alvin.design.ceiling.LevelIOneCeiling;
import com.alvin.design.ceiling.LevelTwoCeiling;
import com.alvin.design.coat.DuluxCoat;
import com.alvin.design.coat.LiBangCoat;
import com.alvin.design.floor.ShengXiangFloor;
import com.alvin.design.tile.DongPengTile;
import com.alvin.design.tile.MarcoPoloTile;
...
public class DecorationPackageController {
    ...
    public String getMatterList(BigDecimal area, Integer level) {
        ...
        if (3 == level) {
            ...
            LevelIOneCeiling levelOneCeiling = new LevelIOneCeiling();  // 吊顶，二级顶
            LiBangCoat liBangCoat = new LiBangCoat();                 // 涂料，立邦
